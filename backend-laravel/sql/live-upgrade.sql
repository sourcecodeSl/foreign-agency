...
UPDATE `roles` SET `permissions` = '{"agencies":{"view":false,"create":false,"edit":false,"delete":false},"candidates":{"view":true,"create":true,"edit":true,"delete":true},"users":{"view":false,"create":false,"edit":false,"delete":false},"roles":{"view":false,"create":false,"edit":false,"delete":false},"reports":{"view":false,"create":false,"edit":false,"delete":false},"billing":{"view":false,"create":false,"edit":false,"delete":false},"settings":{"view":false,"create":false,"edit":false,"delete":false}}' WHERE `slug` = 'agency_owner';
UPDATE `roles` SET `permissions` = '{"agencies":{"view":false,"create":false,"edit":false,"delete":false},"candidates":{"view":true,"create":true,"edit":true,"delete":true},"users":{"view":false,"create":false,"edit":false,"delete":false},"roles":{"view":false,"create":false,"edit":false,"delete":false},"reports":{"view":false,"create":false,"edit":false,"delete":false},"billing":{"view":false,"create":false,"edit":false,"delete":false},"settings":{"view":false,"create":false,"edit":false,"delete":false}}' WHERE `slug` = 'agency_manager';
